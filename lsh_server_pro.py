...
class lsh_server:
    ...
    def loop(self):
        ...
        for i in range(self.worker_num):
            child = Process(target=self.worker, args=(i, self.url_worker, self.context,self.worker_counts,))
            child.start()
    ...
    def worker(self,name, url_worker, context, worker_counts):
        ...
        while True:
            try:
                ...
                for query in query_arr:
                    ...
                    confidences.append(getsimi(query,self.feature[result]) if result != None else None)
